...
**Funding and BD activity** — the ADDF's $5M investment in MindImmune — reflects growing institutional conviction that immune pathway modulation is a primary AD mechanism rather than a secondary consequence of protein aggregation. The ADDF's track record and rigorous scientific review process means this backing carries quality signal beyond the dollar amount: the Foundation has historically funded programs that reached commercial markets, and its endorsement of the immune modulation class is a meaningful data point for other investors evaluating early-stage neuroinflammation programs.

The period reflects a broader maturation of the neurodegeneration pipeline beyond amyloid: all four events involve mechanisms targeting synaptic dysfunction, tau aggregation, or upstream immune modulation — none are amyloid-directed. This diversification of mechanism is the defining trend in the current AD development landscape.
...
The report covers four events across three companies (Cognition Therapeutics, Voyager Therapeutics, MindImmune) and two indications (Dementia with Lewy Bodies, Alzheimer's Disease). Payer and market access analysis is outside the scope of this edition.

This report was prepared by Batu Akkas, Chief Pipeline Intelligence Officer. All clinical and regulatory interpretations reflect publicly available information as of the delivery date. <sup>[[1]](#ref-1)</sup> <sup>[[2]](#ref-2)</sup> <sup>[[3]](#ref-3)</sup>
