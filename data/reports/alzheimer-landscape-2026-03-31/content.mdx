...
- **PrimeC (NeuroSense Therapeutics):** NeuroSense rescheduled its Health Canada pre-NDS meeting to May 2026 to allow incorporation of additional emerging clinical, biomarker, and survival data into the regulatory package, and simultaneously signaled a near-term readout from its Alzheimer's disease study expected in the coming weeks. <sup>[[7]](#ref-7)</sup>
...
| NeuroSense Therapeutics | PrimeC | Fixed-dose combination (ciprofloxacin + celecoxib); targets neuron degeneration, inflammation, iron accumulation, impaired RNA regulation | Health Canada pre-NDS (ALS); Alzheimer's study (near-term readout) | Regulatory Update (Health Canada pre-NDS rescheduled) + Near-Term AD Data Signal | Alzheimer's Disease; ALS | March 24, 2026 |
...
PrimeC is a novel extended-release oral formulation comprising a fixed-dose combination of two FDA-approved drugs — ciprofloxacin and celecoxib — developed by NeuroSense Therapeutics Ltd. (NASDAQ: NRSN). The compound is designed to synergistically target multiple mechanisms associated with neurodegenerative diseases, including neuron degeneration, inflammation, iron accumulation, and impaired RNA regulation. NeuroSense is pursuing PrimeC across two indications: ALS and Alzheimer's disease. Prior ALS data have demonstrated a statistically significant 65% reduction in risk of death, and FDA clearance was obtained to initiate the pivotal Phase 3 PARAGON trial in ALS. PrimeC is being evaluated under Health Canada's NOC/c pathway, which is designed to facilitate earlier access to therapies addressing serious unmet medical needs. <sup>[[7]](#ref-7)</sup>
...
>
> In the same March 24 announcement, NeuroSense disclosed that it expects to report clinical and biomarker results from its Alzheimer's disease study in the coming weeks. No trial identifier, sample size, endpoint structure, dose information, or specific timeline within the "coming weeks" window was provided.

The rescheduling of the Health Canada pre-NDS meeting is presented as a strategic choice to build the strongest possible submission package, consistent with the CEO's stated objective of presenting the most comprehensive and robust dataset possible to Health Canada to maximize the likelihood of a constructive regulatory pathway. The dual-program announcement — regulatory filing strategy for ALS and near-term clinical data for AD in a single release — reflects NeuroSense's active advancement of PrimeC across both indications simultaneously.
...
**Regulatory activity** produced two distinct events that together illustrate the range of regulatory postures in AD-adjacent development. The EMA withdrawal for blarcamesine is a definitive setback — CHMP declined to issue a positive opinion, eliminating blarcamesine's near-term EU path and raising questions about the sufficiency of SIGMAR1-focused Phase 2b/3 data. The NeuroSense/PrimeC event is structurally different: a proactive rescheduling of a Health Canada pre-NDS meeting to May 2026 to incorporate additional clinical, biomarker, and survival data — characterized by management as a strategic choice to strengthen the regulatory package rather than a forced delay. Both events underscore the same underlying dynamic visible across the trial-stage programs in this period — pTau217 enrichment for buntanetap, amyloid confirmation for PMN310 — that biomarker-anchored regulatory strategy is increasingly the expectation, not a differentiator.
...
The report covers seven events across seven companies (Acumen Pharmaceuticals, Anavex Life Sciences, NKGen Biotech, Annovis Bio, ProMIS Neurosciences, Lunai Bioworks, NeuroSense Therapeutics) and one primary indication (Alzheimer's Disease; PrimeC also targets ALS). Both positive developments and regulatory setbacks are covered with equivalent analytical depth.

This report was prepared by Batu Akkas, Chief Pipeline Intelligence Officer. All clinical and regulatory interpretations reflect publicly available information as of the delivery date. <sup>[[1]](#ref-1)</sup> <sup>[[2]](#ref-2)</sup> <sup>[[3]](#ref-3)</sup> <sup>[[4]](#ref-4)</sup> <sup>[[5]](#ref-5)</sup> <sup>[[6]](#ref-6)</sup> <sup>[[7]](#ref-7)</sup>
...
<span id="ref-7"></span>**[7]** "NeuroSense Advances Toward Key Regulatory Milestones with Strengthened Data Package and Near-Term Alzheimer's Readout." *NeuroSense Therapeutics Ltd. / PRNewswire*, March 24, 2026. [Link](https://neurosense.investorroom.com/2026-03-24-NeuroSense-Advances-Toward-Key-Regulatory-Milestones-with-Strengthened-Data-Package-and-Near-Term-Alzheimers-Readout)
