...
3. Add environment variables (Settings → Environment Variables, apply to Production):
   ...
   - `CUSTOMER_REPORT_ID` — slug of the single report they may view (e.g. `tnf-alpha-landscape-2026-03-10`)
...
- They're redirected to `/reports/<CUSTOMER_REPORT_ID>` and can chat with that report.
- Every other route (dashboard, reports list, other reports, commission) redirects them back to their report.
